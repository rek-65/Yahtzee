...
class GameCoordinator(
    ...
    /**
     * Returns the additional Yahtzee bonus earned by the specified player.
     *
     * @param playerIndex Index of the player.
     * @return Total additional Yahtzee bonus points for that player.
     */
    fun getAdditionalYahtzeeBonus(playerIndex: Int): Int {
        return controller.getAdditionalYahtzeeBonus(playerIndex)
    }
